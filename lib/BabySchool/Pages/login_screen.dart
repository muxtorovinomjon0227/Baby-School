import 'package:baby_school/BabySchool/constants/Colors/splashScreenColors.dart';
import 'package:flutter/material.dart';

import 'Register/register_step.dart';
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Stack(
          children: <Widget>[
            ...
            Column(
              children: [
                Container(height: MediaQuery.of(context).size.height*0.1166),
                Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
